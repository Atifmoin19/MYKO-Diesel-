...
const Home = () => {
  ...
  return (
    <div className="home">
      {/* Hero Section */}
      <section className="hero" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("/images/hero-bg.jpg")' }}>
        <div className="container">
          <div className="hero-content">
            <h1>{t('heroTitle')}</h1>
            <p>{t('heroSubtitle')}</p>
            <Link to="/contact" className="btn">{t('getInTouch')}</Link>
          </div>
        </div>
      </section>
